        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacing={200}>
          <Stack spacing={4}>
            ...
            <Heading textAlign={"left"}>
                search and rescue robot: alex
            </Heading>
            <Text textAlign={"left"} color={"gray.500"} fontSize={"lg"}>
              alex is a search and rescue robot that is remote-operated and is able to map out its surroundings.
            </Text>
            <Stack
              spacing={4}
              divider={
            ...
            >
              ...
              />
              <Feature
                icon={<Icon as={IoNavigateCircle} color={"green.500"} w={5} h={5} />}
